...
# ==========================================
# FITUR BARU: Rute Memindahkan Urutan Lagu
# ==========================================
@app.route('/api/move', methods=['POST'])
def move_song():
    data = request.json
    song_id = data.get('id')
    direction = data.get('direction') # Menerima perintah 'up' (atas) atau 'down' (bawah)

    playlist = read_playlist()
    idx = -1
    # Cari lagu ada di urutan (index) ke berapa
